package com.github.myapplication.shenfenzhen.widget;
...
import com.github.myapplication.shenfenzhen.utils.CameraUtils;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (camera != null) {
            try {
                ...
                if (bestSize != null) {
                    Log.i("result_bestSizeWW",bestSize.width+" ");
                    Log.i("result_bestSizeHH",bestSize.height+" ");
                    parameters.setPreviewSize(bestSize.width, bestSize.height);
                    parameters.setPictureSize(bestSize.width, bestSize.height);
                } else {
                    Log.i("result_bestSizeWWww",1920+" ");
                    Log.i("result_bestSizeHHhh",1080+" ");
